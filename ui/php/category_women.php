...
<!-- header section ends -->
  ...
  <!-- navbar start -->
    ...
    <div class="login">
        ...
        <i class="fa-solid fa-square-caret-down"></i>
        <div class="login_content">
            <a href="#heel">Ladies Heel </a>
                <a href="#shoes">Ladies Sports Shoes </a>
                <a href="#sandals">Ladies Sandals </a>
                <a href="#shoes">Ladies Shoes </a>
        </div>
    </div>
     <!-- admission End --> 
    ...
    <div class="login">
        <a href="category_kids.php">Kids </a>
        <i class="fa-solid fa-square-caret-down"></i>
        <div class="login_content">
...
<section class="products" id="shoes">
    ...
    <h1 class="heading"> Women     <span>sports shoe</span> </h1>
...
$sql="Select * from product where category='Bata' and gender='Female' and sub_category='Sneaker' ORDER BY id DESC   ";
...
<section class="product" id="sneakers">
    ...
    <h1 class="heading"> Women <span>sneakers</span> </h1>
...
<section class="product" id="sandals">
    ...
    <h1 class="heading"> Women  <span>sandals</span> </h1>
    <div class="box-container">
<?php
 $sql="Select * from product   where category='Bata' and gender='Female' and sub_category='Sandal' ORDER BY id DESC ";
$result=mysqli_query($conn,$sql);
if($result){
   while($row=mysqli_fetch_assoc($result)){
     //assign row value
