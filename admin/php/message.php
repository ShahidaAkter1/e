 ...
 <div class="section">
  ...
  <!--side bar start  -->
   ...
   <div class="sidebar">
    ...
    <li><a href="#" target="_blank" class="active"><span class="icon"><i class="fa-regular fa-message"></i></span><span class="item">Message</span></a></li>
     ...
     //assign row value
       ...
       <tr>
          <td>$id</td>    
           ...
           <td>$message</td>
          <td>          
          <button class='btn'> <a href='view.php?view_Id=".$row['id']."'  >View</a></button>
          <button class='btn_danger'>   <a href='message.php?delete_Id=".$row['id']."' >Delete</a>  </button>
             </td>
           </tr>
