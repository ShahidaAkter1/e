 ...
 <div class="section">
  ...
  <!--side bar start  -->
   ...
   <div class="sidebar">
    ...
    <li><a href="product.php"  target="_blank"  class="active"><span class="icon" ><i class="fa-brands fa-product-hunt"></i></span><span class="item">All Products</span></a></li>
 ...
 ///fetch row from the table
   while($row=mysqli_fetch_assoc($result)){
     //assign row value
       ...
       <div class="box">
       <div class="icons">
       <a href="view_product_description.php?view_Id='.$row["id"].'"  class="fas fa-eye"> </a>
...
<h3> $name</h3>
<div class='price'>TK$price<span> </span></div>
 

<button class='btn'> <a href='update_product.php?update_product_Id=".$row['id']."'  >Update</a></button>
<button class='btn_danger'>   <a href='product.php?delete_Id=".$row['id']."' >Delete</a>  </button>
